...
# Purpose: sweep learning rate, batch size, beta, sign weight, and dz weight.
# Full run (18 configurations):
#   bash scripts/model_experiments/run_ha_dvf_dz_sign_tuning.sh
# Recommended quick smoke (one named configuration, one epoch):
#   QUICK=1 EXPERIMENTS=lr5e-5_bs96_beta0.5_sign0.2_dzw3 bash scripts/model_experiments/run_ha_dvf_dz_sign_tuning.sh
